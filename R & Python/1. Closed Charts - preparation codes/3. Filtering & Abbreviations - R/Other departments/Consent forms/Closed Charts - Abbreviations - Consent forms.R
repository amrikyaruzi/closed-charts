...
View(data)
data1 <- data %>% filter(DOCUMENTED == 'D' & SNN == 5.5)
View(data1)
data2 <- data1 %>% select(DOCTOR:DOCUMENTS, LEGIBLE)
View(data2)

write.csv(data2, "Q3 - Use of Abbreviations on consent forms.csv")

reticulate::repl_python()
import pandas as pd
data = pd.read_csv(r"C:/Users/amri.kyaruzi/Documents/Q2 - Use of Abbreviations on consent forms.csv")
data.head(5)
