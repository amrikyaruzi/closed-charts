#C:/Users/amri.kyaruzi/Documents/Python/Projects/Closed Charts Audits/Monthly/1. January 2020/Emergency department/A&E January 2020.csv
...
library(dplyr)
library(readr)
closedchartsdataDAE <- read_csv("C:/Users/amri.kyaruzi/Documents/Python/Projects/Closed Charts Audits/Monthly/1. January 2020/Emergency department/A&E January 2020.csv")
...
##DAE
#DOCUMENTED
DAEPenultimate <- dt %>% filter(TYPE == "P") %>% filter(DOCTOR == "Shaffin") %>% filter(SNN == 1.1 | SNN == 5.2 | SNN == 5.4 | SNN == 8.1) 
