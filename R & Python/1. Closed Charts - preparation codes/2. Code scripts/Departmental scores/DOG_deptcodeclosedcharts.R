...
##DOG
#DOCUMENTED
DOGPenultimate <- dt %>%  filter(TYPE == "P" | TYPE == "N") %>% filter(SNN == 1.1 | SNN == 1.2 | SNN == 1.4 | SNN == 2.1 | SNN == 2.2 | SNN == 2.3 | SNN == 3.1| SNN== 3.2| SNN == 3.3 | SNN == 4.1 | SNN == 5.2 | SNN == 5.4 | SNN == 5.5 | SNN == 6.1 |SNN == 7.1 | SNN == 7.3 | SNN == 8.1) %>% filter(DEPT == "DOG")
...
DEPT_TLC_AVERAGE <- (PercentTimelyDOG + PercentLegibleDOG + PercentCompleteDOG)/3

#Maternity Departmental Scores:
